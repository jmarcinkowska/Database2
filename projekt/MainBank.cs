...
namespace projekt
{
    class MainBank
    {
        ...
        public static bool sendMoney(double amountOfMoney, String SenderID, String ReciverID)
        {
            ...
            dict1 = departmentID(SenderID);
            dict2 = departmentID(ReciverID);
        ...
        public static void registerClient(String name, String surname, String city, String pesel, double balance, String department)
        {
            try
            {
